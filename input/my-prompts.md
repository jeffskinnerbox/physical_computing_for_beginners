...
Convert the KY-040 Rotary Encoder debouncing code within `@lesson_scripts/class-02-lesson-script.md`
to the design pattern used in `@lesson_scripts/class-01-lesson-script.md`
